...
define('DATABASE_USER', $_SERVER['DB_USER']);
define('DATABASE_PASS', $_SERVER['DB_PASSWORD']);
define('DATABASE_HOST', $_SERVER['DB_HOST']);
define('DATABASE_NAME', $_SERVER['DB_NAME']);
define('DATABASE_PORT', $_SERVER['DB_PORT']);
